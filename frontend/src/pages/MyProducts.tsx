...
import { MapPin, Package, DollarSign, Tag, Plus } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto p-3 sm:p-6 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex flex-wrap sm:flex-nowrap gap-2 sm:justify-end w-full sm:w-auto">
            <button className="btn w-full sm:w-auto" onClick={() => setOpenCreate(true)}>+ Sell Product</button>
          </div>
        </div>
        ...
        <div className="-mx-3 sm:mx-0">
          <div className="p-[1px] bg-gradient-to-r from-cyan-400 to-purple-500 rounded-none sm:rounded-xl">
            <div className="flex items-center gap-1 themed-card rounded-none sm:rounded-xl px-1 py-1 w-full flex-nowrap" style={{ background: 'var(--card)' }}>
              <span className={`px-2 py-1 text-[12px] font-semibold leading-tight rounded-md flex-none border bg-cyan-600 text-white border-cyan-500`}>My Products</span>
              <input
                type="text"
